...
const photos = [
  { src: '/images/gallery-1.jpg',  caption: 'Blessed & Coffee Obsessed',  tag: 'The Entrance' },
  { src: '/images/gallery-2.jpg',  caption: 'Stone Walls & Bottle Caps',   tag: 'The Courtyard' },
  { src: '/images/gallery-3.jpg',  caption: 'The Garden Fireplace',        tag: 'Outdoors' },
  { src: '/images/gallery-4.jpg',  caption: 'Golden Evenings Outside',     tag: 'Night' },
